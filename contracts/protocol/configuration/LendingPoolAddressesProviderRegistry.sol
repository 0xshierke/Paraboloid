 ...
 * @dev Main registry of LendingPoolAddressesProvider of multiple SParaboloiddy protocol's markets
 * - Used for indexing purposes of Paraboloid protocol's markets
 * - The id assigned to a LendingPoolAddressesProvider refers to the market it is connected with,
 *   for example with `0` for the Paraboloid main market and `1` for the next created
