...
import {Ownable} from '../../dependencies/contracts/Ownable.sol';

// Prettier ignore to prevent buidler flatter bug
// prettier-ignore
import {InitializableImmutableAdminUpgradeabilityProxy} from '../libraries/paraboloid-upgradeability/InitializableImmutableAdminUpgradeabilityProxy.sol';
 ...
 * - Owned by the Paraboloid Governance
 * @author Paraboloid, inspiration from Aave
 **/
contract LendingPoolAddressesProvider is Ownable, ILendingPoolAddressesProvider {
  ...
  // LENDING_POOL: This represents the address of the LendingPool contract, which is responsible for managing the lending functionality of the protocol.
  bytes32 private constant LENDING_POOL = 'LENDING_POOL';
  // LENDING_POOL_CONFIGURATOR: This represents the address of the LendingPoolConfigurator contract, which handles the configuration and initialization of the lending pool.
  bytes32 private constant LENDING_POOL_CONFIGURATOR = 'LENDING_POOL_CONFIGURATOR';
  // POOL_ADMIN: This stores the address of the pool administrator, who has the permission to manage the lending pool.
  bytes32 private constant POOL_ADMIN = 'POOL_ADMIN';
  // EMERGENCY_ADMIN: This stores the address of the emergency administrator, who has the permission to perform emergency actions within the pool.
  bytes32 private constant EMERGENCY_ADMIN = 'EMERGENCY_ADMIN';
  // LENDING_POOL_COLLATERAL_MANAGER: This stores the address of the LendingPoolCollateralManager, which is responsible for managing collateral assets within the lending pool.
  bytes32 private constant LENDING_POOL_COLLATERAL_MANAGER = 'COLLATERAL_MANAGER';
  // PRICE_ORACLE: This stores the address of the price oracle contract, which provides price data for assets used within the lending protocol.
  bytes32 private constant PRICE_ORACLE = 'PRICE_ORACLE';
  // LENDING_RATE_ORACLE: This stores the address of the lending rate oracle contract, which provides interest rate data for borrowing and lending operations.
  bytes32 private constant LENDING_RATE_ORACLE = 'LENDING_RATE_ORACLE';
  // INCENTIVE_CONTROLLER: This represents the address of the IncentiveController contract, which handles the distribution of incentives or rewards within the protocol.
  bytes32 private constant INCENTIVE_CONTROLLER = 'INCENTIVE_CONTROLLER';
  // INCENTIVE_TOKEN: This stores the address of the incentive token contract, which is the token used for distributing incentives.
  ...
  /**
   * @dev Returns the id of the Paraboloid market to which this contracts points to
